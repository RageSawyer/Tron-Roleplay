...
Pkr_PlayerShowDialog(const playerid, const gameId, const SIT_DIALOG_ERROR: error = SIT_DIALOG_ERROR: NONE)
{
    ...
    format(_format, 2048, "%sParanýz: {00AD43}$%s{A9C4E4}.\nOrtalama Oyuncu Çipleri: {00AD43}$%.0f{A9C4E4}.\nBüyük Kör Bahis: {00AD43}$%s{A9C4E4}.\nKüçük Kör Bahis: {00AD43}$%s{A9C4E4}.\nOyuncu Sayýsý: %i/6.", _format, Pkr_FormatNumber(PlayerData[playerid][pCash]), Float:Pkr_ReturnAverageChips(gameId), Pkr_FormatNumber((g_rgPokerGames[gameId][BLIND] << 1)), Pkr_FormatNumber(g_rgPokerGames[gameId][BLIND]), Pkr_GetAmountOfPlayersOnGame(gameId));
...
Pkr_PlayerShowConfirmDialog(const playerid)
{
    ...
    format(_format, sizeof(_format), "%sÇipleriniz: {00AD43}$%s{A9C4E4}.\nBu doðrulamadan önce paranýz: {00AD43}$%s{A9C4E4}.\nBu doðrulamadan sonra paranýz: {00AD43}$%s{A9C4E4}.\n\nDevam etmek için '{FF9900}Onayla{A9C4E4}' yada geri dönmek için '{FF9900}Geri{A9C4E4}' týklayýn.", _format, Pkr_FormatNumber(_sitcash), Pkr_FormatNumber(PlayerData[playerid][pCash]), Pkr_FormatNumber(PlayerData[playerid][pCash] - _sitcash));
...
PkrCMD_Spectate(const playerid) {
	...
	if(GetPVarType(playerid, POKER_SPECTATE_VAR_NAME) == PLAYER_VARTYPE_NONE) {
		...
		SendClientMessage(playerid, COLOR_GREENYELLOW, "Poker oyununu seyretmeye baþladýn.");
	...
	SendClientMessage(playerid, COLOR_GREENYELLOW, "Poker oyununu seyretmeyi býraktýn.");
...
Pkr_PlayerDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    ...
    switch(_pokerDialogId)
    {
        case (POKER_DIALOGS: SIT):
        {
            ...
            new _iPlayerMoney = PlayerData[playerid][pCash];
